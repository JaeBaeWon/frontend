...
const ShowPayInfo = ({ reservationId }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_BASE_URL}/payment/info/${reservationId}`, {
        headers: {
    ...
    <div className="payment-complete-container">
      ...
      <div className="payment-info-sections">
        <div className="info-block">
          <h4>예매 정보</h4>
          <p>
            <strong>티켓번호</strong> {paymentInfo.ticketNumber}
          </p>
          <p>
            <strong>공연정보</strong>
            <br />
            {paymentInfo.performanceTitle}
            <br />
            {paymentInfo.performanceLocation}
            <br />
            {paymentInfo.performanceDate}
          </p>
          <p>
            <strong>좌석정보</strong> {paymentInfo.seatInfo}
          </p>
        </div>
        ...
        <div className="info-block">
          ...
          <p>
            <strong>결제 방식</strong> {paymentInfo.payType}
          </p>
          <p>
            <strong>결제 시간</strong> {paymentInfo.paymentTime}
          </p>
        </div>
      </div>
