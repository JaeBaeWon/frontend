...
function ReservationDetail() {
  ...
  if (error || !reservationDetail) return <div className="container">{error}</div>;
      ...
      <div className="content">
        ...
        <div className="section">
          ...
          <div className="paySummary">
            ...
            <div>
              환불 금액{" "}
              <span>{reservationDetail.refundAmount?.toLocaleString() || "0"}원</span>
            </div>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="cautionBox">
            <b>취소 마감시간</b>{" "}
            <span className="cancelDeadline">{reservationDetail.cancelDeadline}</span>
          </div>
          <div className="cautionBox">
            <b>취소 수수료</b> <br />
            <span>
              <b>취소일자에 따라 취소수수료가 달라집니다.</b>
              <br />* 예매당일 밤 12시 이전 취소 시 취소수수료 없음(취소기한 내에 한함)
            </span>
